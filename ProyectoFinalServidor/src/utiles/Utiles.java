...
public class Utiles {
    ...
    public static User descifrarObjeto(SealedObject objetcoCifrado, PrivateKey clavePriv) {

        User userDescifrado = null;
        ...
        try {
            ...
            //Creamos un objeto encapsulado con el cipher
            userDescifrado = (User) objetcoCifrado.getObject(c);
            System.out.println(userDescifrado.getEmail());
        } catch (NoSuchAlgorithmException | NoSuchPaddingException | InvalidKeyException | IOException
                | ClassNotFoundException | IllegalBlockSizeException | BadPaddingException ex) {
        }

        return userDescifrado;
    }
